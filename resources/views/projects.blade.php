                    ...
                    <div class="group flex flex-col h-full bg-white border border-gray-200 shadow-sm rounded-xl">
                        ...
                        <div class="mt-auto flex border-t border-gray-200 divide-x divide-gray-200">
                            @if($user->id == $project->project_manager)
                                <a href="/panel/projects/{{$project->id}}/edit" class="w-full py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-b-xl bg-white text-gray-800 shadow-sm hover:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none" href="#">
                                    Control Panel
                                </a>
                            @endif
                        </div>
